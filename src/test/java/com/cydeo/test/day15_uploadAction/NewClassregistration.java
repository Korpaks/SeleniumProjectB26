...
public class NewClassregistration {
...
//    10.Enter date of birth
        Random rand = new Random();Driver.getDriver().findElement(By.xpath("//input[@name='birthday']")).sendKeys(rand.nextInt(12)+"/"+rand.nextInt(30)+"/"+faker.numerify("19##"));
